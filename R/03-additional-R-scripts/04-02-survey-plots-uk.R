...
GAD_SPin_plot_uk <- GamingData_clean_UK %>% 
...
GAD_SWL_plot_uk <- GamingData_clean_UK %>% 
...
SPIN_SWL_plot_uk <- GamingData_clean_UK %>% 
...
pairs(GamingData_clean_UK[, c("Hours", "GAD_T", "SWL_T", "SPIN_T")])

cor(GamingData_clean_UK[, c("Hours", "GAD_T", "SWL_T", "SPIN_T")], method = "spearman")
cor(GamingData_clean_UK[GamingData_clean_UK$Gender == "Female", c("Hours", "GAD_T", "SWL_T", "SPIN_T")], method = "spearman")
cor(GamingData_clean_UK[GamingData_clean_UK$Gender == "Male",   c("Hours", "GAD_T", "SWL_T", "SPIN_T")], method = "spearman")
cor(GamingData_clean_UK[GamingData_clean_UK$Gender == "Other",  c("Hours", "GAD_T", "SWL_T", "SPIN_T")], method = "spearman")


GamingData_clean_UK %>% select(Gender, all_of(c("Hours", "GAD_T", "SWL_T", "SPIN_T"))) %>% 
  group_by(Gender) %>% 
  cor()
