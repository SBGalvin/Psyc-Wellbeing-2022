...
GAD_SPin_plot_us <- GamingData_clean_US %>% 
...
GAD_SWL_plot_us <- GamingData_clean_US %>% 
...
SPIN_SWL_plot_us <- GamingData_clean_US %>% 
...
GamingData_clean_US %>% 
  ...
  geom_jitter(size = 1, alpha = .4, width = .25, colour = "red")+
...
pairs(GamingData_clean_US[, c("Hours", "GAD_T", "SWL_T", "SPIN_T")])

cor(GamingData_clean_US[, c("Hours", "GAD_T", "SWL_T", "SPIN_T")], method = "spearman")
cor(GamingData_clean_US[GamingData_clean_US$Gender == "Female", c("Hours", "GAD_T", "SWL_T", "SPIN_T")], method = "spearman")
cor(GamingData_clean_US[GamingData_clean_US$Gender == "Male",   c("Hours", "GAD_T", "SWL_T", "SPIN_T")], method = "spearman")
cor(GamingData_clean_US[GamingData_clean_US$Gender == "Other",  c("Hours", "GAD_T", "SWL_T", "SPIN_T")], method = "spearman")


GamingData_clean_US %>% select(Gender, all_of(c("Hours", "GAD_T", "SWL_T", "SPIN_T"))) %>% 
  group_by(Gender) %>% 
  cor()
